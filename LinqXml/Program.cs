...
namespace LinqXml
{
    class Program
    {
        ...
        static void Task33()
        {
            Console.WriteLine("Дан XML-документ. Для каждого элемента перво-го уровня, имеющего атрибуты, добавить в конец его дочер-них узлов элемент с именем attrи атрибутами, совпадаю-щими  с  атрибутами  обрабатываемого  элемента  первого уровня, после чего удалить все атрибуты у обрабатываемого элемента. Добавленный элемент attrдолжен быть представ-лен в виде комбинированного тега. Указание.  Использовать  метод  ReplaceAttributes,  указав  в качестве параметра новый дочерний элемент. \n");
